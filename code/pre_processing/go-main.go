...
var (
	...
	basicStatsCsv       = "../../data/raw/Basic_Stats.csv"
	basicStatsData      = [][]string{}
	careerReceivingCsv  = "../../data/raw/Career_Stats_Receiving.csv"
	careerReceivingData = [][]string{}
	careerRushingCsv    = "../../data/raw/Career_Stats_Rushing.csv"
	careerRushingData   = [][]string{}
	careerPassingCsv    = "../../data/raw/Career_Stats_Passing.csv"
	careerPassingData   = [][]string{}
	gameRbCsv           = "../../data/raw/Game_Logs_Runningback.csv"
	gameRbData          = [][]string{}
	gameWrTeCsv         = "../../data/raw/Game_Logs_Wide_Receiver_and_Tight_End.csv"
	gameWrTeData        = [][]string{}
	gameQbCsv           = "../../data/raw/Game_Logs_Quarterback.csv"
	gameQbData          = [][]string{}
...
func main() {
	...
	dt := time.Now()
	date := dt.Format("20060201_150405")
	filename := date + "_formatted-data.csv"
	outputPath := "../../data/clean_formatted/" + filename
	log.Printf("will write csv to %s", outputPath)
