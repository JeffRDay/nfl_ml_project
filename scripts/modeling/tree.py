...
def main():
    ...
    logging.info("will use %s records for Decision Tree Regression", size)
    ...
    results = model("Decision Tree Regression",predictors, target)
    ...
    print("executed tree.py in :", end-start)
